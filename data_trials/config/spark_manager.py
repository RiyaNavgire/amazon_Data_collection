from data_trials.constant.environment.variable_key import AWS_ACCESS_KEY_ID_ENV_KEY,AWS_SECRET_ACCESS_KEY_ENV_KEY
...
spark_session = SparkSession.builder.master('local[*]').appName('calgary_news') \
    ...
    .config('spark.jars.packages',"com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.4")\
    .getOrCreate()
    # 
